...
const ExperienceCard = ({ experience, onEdit, onDelete }) => {
	return (
		<Motion.div
			...
			className="group bg-white dark:bg-[#0b1120] rounded-[2rem] p-5 md:p-6 border border-gray-100 dark:border-white/5 transition-all shadow-xl relative overflow-hidden"
		>
			...
			<div className="flex items-start justify-between gap-4 relative z-10">
				<div className="flex items-start gap-4">
					<div className="w-12 h-12 rounded-xl bg-gray-50 dark:bg-[#030712] border border-gray-100 dark:border-white/5 flex items-center justify-center text-xl text-orange group-hover:scale-110 transition-transform shrink-0">
						<HiOutlineBriefcase />
					</div>
			...
			{experience.description && (
				<p className="mt-4 text-[11px] text-gray-500 leading-relaxed font-medium opacity-60 pl-3 border-l-2 border-gray-100 dark:border-white/5 whitespace-pre-wrap line-clamp-3">
					{experience.description}
				</p>
			)}
		</Motion.div>
