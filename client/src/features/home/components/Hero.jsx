	...
	return (
		...
		>
			...
			<div className="container mx-auto px-4 text-center relative z-10">
				...
				>
					<div className="flex items-center gap-2 px-5 py-2 rounded-full bg-gray-900/50 border border-gray-800 shadow-2xl backdrop-blur-sm">
				...
				>
					<div className="flex items-center gap-4">
						...
						<div className="text-left">
							...
							<a href={`mailto:${admin?.email || "mohamed20rafat@gmail.com"}`} className="text-sm font-bold text-white hover:text-orange transition-colors">
					...
					<div className="hidden sm:flex items-center gap-4">
						...
						<div className="text-left">
							...
							<a href={`tel:${admin?.phoneNumber || "+201050330514"}`} className="text-sm font-bold text-white hover:text-orange transition-colors">
