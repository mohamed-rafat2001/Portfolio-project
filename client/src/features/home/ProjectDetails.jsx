...
const ProjectDetails = () => {
    ...
    return (
        <div className="bg-[#030712] min-h-screen text-white pb-32 overflow-hidden selection:bg-orange/30">
            {/* Header / Hero Section */}
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center gap-6 mb-12">
                            <button 
                                ...
                                className="group inline-flex items-center gap-3 px-6 py-2.5 bg-white/5 border border-white/10 rounded-full text-[10px] font-black uppercase tracking-[0.4em] text-white hover:bg-white/10 transition-all shadow-2xl"
                            >
                                <HiOutlineArrowLeft className="text-xs transition-transform group-hover:-translate-x-1" />
                                <span>Back to projects</span>
                            </button>
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-400 bg-blue-500/10 px-4 py-2 border border-blue-500/20 rounded-lg">
                                {architecture || "Web Ecosystem"}
                            </span>
                        </div>

                        <h1 className="text-5xl md:text-8xl lg:text-[9.5vw] font-black uppercase tracking-tighter leading-[0.8] mb-12 max-w-full drop-shadow-[0_20px_80px_rgba(255,255,255,0.05)]">
                            {title}
                        </h1>
            ...
            <div className="container mx-auto px-4 -mt-20 relative z-20">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                                ...
                                <div className="space-y-10 relative z-10">
                                    <div className="flex flex-col gap-8">
                                        <div className="prose prose-invert max-w-none">
                                            <div className="text-gray-400 text-lg font-medium leading-[1.8] opacity-80">
                                        ...
                                        {hasLongDescription && (
                                            <div className="flex justify-center md:justify-start">
                                                <button 
                                                    ...
                                                    className="px-10 py-3.5 bg-black border border-white/10 rounded-full text-[10px] font-black uppercase tracking-[0.3em] text-white hover:bg-orange hover:border-orange transition-all shadow-xl active:scale-95"
                                                >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-10 border-t border-white/5">
                                        <div className="p-8 bg-black/40 rounded-[1.5rem] border border-white/5 flex items-center gap-6 group/box hover:border-orange/20 transition-all">
                                            ...
                                            <div>
                                                ...
                                                <span className="text-xs font-black uppercase text-white tracking-widest">{status}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-8 bg-black/40 rounded-[1.5rem] border border-white/5 flex items-center gap-6 group/box hover:border-blue-500/20 transition-all">
                                            ...
                                            <div>
                                                <span className="text-[9px] font-black text-gray-500 uppercase tracking-widest block mb-1">Architecture</span>
                                                <span className="text-xs font-black uppercase text-white tracking-widest">{architecture}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section className="space-y-12">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <h2 className="text-[11px] font-black uppercase tracking-[0.4em] text-white/90">Project Gallery</h2>
                                </div>
                                <div className="flex items-center gap-6">
                                    <div className="flex gap-2">
                                        <button className="gallery-prev-btn w-10 h-10 rounded-full bg-[#0a0f1c] border border-white/5 flex items-center justify-center hover:bg-orange transition-all text-white/40 cursor-pointer shadow-lg hover:text-white">
                                            <HiChevronLeft className="text-lg" />
                                        </button>
                                        <button className="gallery-next-btn w-10 h-10 rounded-full bg-[#0a0f1c] border border-white/5 flex items-center justify-center hover:bg-orange transition-all text-white/40 cursor-pointer shadow-lg hover:text-white">
                                            <HiChevronRight className="text-lg" />
                                        </button>
                                    </div>
                                    <div className="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] font-mono">
                                        <span className="text-white text-base mr-1">{activeIndex + 1}</span> /<span className="ml-2">{galleryImages.length}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                <Swiper
                                    ...
                                    className="rounded-[2.5rem] overflow-hidden border border-white/5 bg-[#0a0f1c] shadow-2xl"
                                >
                    ...
                    <aside className="lg:col-span-4 space-y-10">
                        ...
                        <div className="space-y-4">
                            ...
                            {repoUrl && (
                                <Motion.a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="group relative flex items-center justify-between px-10 py-7 bg-white text-black rounded-full shadow-2xl overflow-hidden"
                                >
                                    <div className="flex items-center gap-4 relative z-10">
                                        <HiCodeBracket className="text-2xl" /> 
                        ...
                        {/* Tech Stack Card */}
                        <div className="bg-[#0a0f1c]/40 backdrop-blur-3xl rounded-[2.5rem] p-10 border border-white/5 shadow-2xl relative overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            
                            <div className="flex items-center gap-4 mb-16 relative z-10">
                                <div className="w-10 h-10 rounded-xl bg-black border border-white/10 flex items-center justify-center text-orange shadow-lg">
                                    <HiOutlineCircleStack className="text-xl" />
                                </div>
                                <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-white">Technologies</h3>
                            </div>
                                ...
                                {techStack?.map((category, idx) => (
                                    <div key={idx} className="space-y-6">
                                        <div className="flex items-center gap-3 opacity-40">
                                            ...
                                            <h4 className="text-[9px] font-black uppercase tracking-[0.4em] text-white">{category.title}</h4>
                                        </div>
                                        <div className="flex flex-wrap gap-2.5">
                                            {category.techs?.map((tech, tIdx) => (
                                              <Motion.span 
                                                  ...
                                                  className="px-5 py-2.5 bg-black/40 border border-white/5 rounded-xl text-[9px] font-bold uppercase tracking-widest text-gray-400 hover:text-white transition-all shadow-sm"
                                              >
                                                  {tech}
                                              </Motion.span>
                                            ))}
