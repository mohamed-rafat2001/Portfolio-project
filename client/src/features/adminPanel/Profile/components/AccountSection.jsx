		...
		>
			<div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-2.5">
                    ...
                    <div className="flex items-center gap-4 bg-[#030712] border-2 border-white/5 rounded-[1.5rem] px-6 py-4 w-full">
                        ...
                        <span className="text-sm font-bold text-gray-400 uppercase tracking-widest pl-2">Available for projects</span>
                    </div>
                </div>
			</div>
		</FormCard>
