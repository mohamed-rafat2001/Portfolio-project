...
const StatCard = ({ title, value, icon, color }) => {
	return (
		<Motion.div
            ...
            viewport={{ once: true }}
			className="p-10 bg-white dark:bg-[#0b1120] rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-2xl group hover:border-orange/20 transition-all relative flex flex-col justify-between aspect-square"
		>
